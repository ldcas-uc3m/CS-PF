...
\subsection{Justificación e implementación}
...
El diagrama de casos de uso queda reflejado en la \figref{uml-diagrams/use-cases}.
\svgfigure{uml-diagrams/use-cases}{Diagrama de casos de uso del sistema}



% TODO: esta basura de ChadGPT sobra. Hay que meter cada diagrama en una parte del texto anterior (donde sea relevante)
...
% \figref{uml-diagrams/sequence-consulta}
\svgfigure{uml-diagrams/sequence-consulta}{Diagrama de secuencia de una Solicitud de Asesoramiento Personalizado}

% \figref{uml-diagrams/components}
\svgfigure{uml-diagrams/components}{Diagrama de componentes del sistema}

% \figref{uml-diagrams/deployment}
\svgfigure[1]{uml-diagrams/deployment}{Diagrama de despliegue del sistema}
