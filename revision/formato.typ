= Consideraciones generales sobre el formato

// the good
El documento está bien presentado, con un formato agradable a la vista. Se
aprecia el uso de una fuente de texto llamativa, y de distinta escala de grises
en los títulos de los distintos niveles de sección. También se aprecia el uso de
una portada y una tabla de contenidos, así como el uso de sangría y justificado
en el texto.

El uso del logo de la universidad en el encabezado de las páginas también nos
parece un bonito detalle, aunque quizás habría sido más apropiado usar el logo
de la empresa, y mencionar la universidad en la portada, y quizás hubiera sido
...
También nos sorprendió la sección 5, en la cual se hace un uso extenso de puntos de enumeración y listas enumeradas en lugar de párrafos con conectores, el uso de palabras en negrita, el uso del punto en lugar de la coma para los decimales, y el formato de las distintas tablas, el cual es diferente a las anteriores.
